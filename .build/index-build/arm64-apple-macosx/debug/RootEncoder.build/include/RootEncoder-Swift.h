...
#ifndef ROOTENCODER_SWIFT_H
#define ROOTENCODER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RootEncoder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11RootEncoder13CameraManager")
...
@class NSCoder;
@protocol MTLDevice;
SWIFT_CLASS("_TtC11RootEncoder9MetalView")
...
@interface MetalView (SWIFT_EXTENSION(RootEncoder)) <MTKViewDelegate>
- (void)mtkView:(MTKView * _Nonnull)view drawableSizeWillChange:(CGSize)size;
- (void)drawInMTKView:(MTKView * _Nonnull)view;
@end

SWIFT_CLASS("_TtC11RootEncoder17MicrophoneManager")
@interface MicrophoneManager : NSObject <AVCaptureAudioDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC11RootEncoder6Socket")
